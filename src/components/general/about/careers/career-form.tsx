...
const formSchema = z.object({
    ...
    email: z.string({ required_error: 'Email is required' }).email({ message: 'Email format is wrong.' }),
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        ...
                                        <FormControl>
                                            <Input placeholder="Enter job name" {...field} value={field.value ?? ''} />
                                        </FormControl>
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        ...
                                        <FormControl>
                                            <Input placeholder="Enter job code" {...field} value={field.value ?? ''} />
                                        </FormControl>
                            ...
                            <div className="grid gap-2">
                                ...
                                >
                                    {({ open }) => {
                                        ...
                                        return (
                                            <Button type="button"  onClick={handleOnClick} className="w-fit bg-white text-gray-900 hover:text-white">
                                                Upload files
                                            </Button>
                                        );
                                    }}
