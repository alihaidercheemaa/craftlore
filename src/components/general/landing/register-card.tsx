        ...
        <section className="col-span-12  bg-[#e5edf7] pt-32 py-72">
            <div className="container  grid grid-cols-3 gap-4">
                <div className="col-span-3 lg:col-span-2">
                    ...
                    <h4 className="text-[29px] leading-[31px] font-bold font-montserrat">Unlock Everything Our Platform Offers-At No Cost to You</h4>
                    <h4 className="text-[35px] leading-[32px] text-secondary font-bold font-montserrat py-3">A wealth of tools and insights, completely free.</h4>
                        ...
                        REGISTER.map((register, index) => (
                            ...
                            >
                                <div className="flex flex-col py-5 gap-2">
                                    ...
                                    <p className=" text-gray-900 text-sm font-light  group-hover:text-white font-montserrat my-6">{register.description}</p>
