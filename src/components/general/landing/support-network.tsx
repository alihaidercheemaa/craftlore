    ...
    return (
        <section className="col-span-12 bg-primary pb-20">
            <div className="container">
                <div className="container">
                    <div className="bg-white container border-t-4 border-secondary rounded-b-lg py-24 px-20 space-y-4">
                        ...
                        <div className="space-y-6">
                            <p className="text-xl font-opensans">In the rapidly evolving landscape of the global craft industry, the success of CraftLore’s mission is driven by the unwavering strength and collaboration of a dedicated support network. At the heart of our initiative lies an influential coalition of partners who share our commitment to preserving the authenticity of Kashmiri crafts and revolutionizing Artisan Direct Market Access. Together, we are eliminating the long-standing barriers posed by middlemen and counterfeit trade, creating a transparent and fair marketplace for artisans.</p>
                            <p className="text-xl font-opensans">Our formidable support network is further reinforced by essential contributions from business, administrative, technological, and marketing partners, ensuring that CraftLore continues to grow and thrive on the global stage.</p>
                            <p className="text-xl font-opensans">As a key pillar of financial and business support,<b>B2B Connect USA</b> provides the essential funding and business-to-business connections that fuel CraftLore’s expansion. By forging strategic collaborations between Kashmiri artisans and international markets, they ensure that the craft sector reaches its full potential in the global economy. Their contributions allow us to scale operations, increase artisan visibility, and enhance market access worldwide.</p>
                            <p className="text-xl font-opensans"><b>The Hamdan Craft Revival Foundation</b> is the operational backbone of our initiative. With a focus on administrative excellence, policy advocacy, and organizational leadership, the Foundation plays a pivotal role in the seamless functioning of CraftLore. Their efforts ensure that our mission is not only preserved but advanced through strategic partnerships, thoughtful leadership, and a vision of empowering artisans through cultural preservation and fair trade policies. Their advocacy for Kashmiri crafts sets the stage for CraftLore’s enduring impact in both local and international arenas.</p>
                            <p className="text-xl font-opensans">At the intersection of technology and craft preservation, <b>Prime Logic Solutions USA</b> empowers CraftLore with state-of-the-art digital tools and technological innovations. From blockchain technology to geo-certification protocols, Prime Logic equips us with cutting-edge solutions that guarantee the authenticity and traceability of Kashmiri crafts. Their technological expertise ensures that every craft on our platform is not only verified but protected against counterfeit threats, creating a secure and transparent marketplace for artisans and buyers alike.</p>
                            <p className="text-xl font-opensans">A visionary partner in anticraft marketing and cultural tourism, <b>ArtStay</b> connects craft enthusiasts and art lovers from around the world, positioning Kashmiri artisans at the center of authentic and sustainable travel experiences. By integrating the rich history of Kashmiri craftsmanship with global tourism, ArtStay promotes cultural exchange and elevates artisans on a global stage. Their marketing efforts help bring the stories, traditions, and artistry of Kashmiri crafts to a broader audience, creating meaningful connections between artisans and those who appreciate the true value of handcrafted art.</p>
                        </div>
                    </div>
                    <div className="container flex justify-center relative -mt-10">
