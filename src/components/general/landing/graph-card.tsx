...
export const GraphCard = () => {
    ...
    return (
        <section className="col-span-12 bg-white h-[1000px]">
            <div className="container mx-auto grid grid-cols-2">
                <p className="col-span-2 bg-primary text-white text-center py-12 font-opensans text-5xl font-bold rounded-t-xl relative -mt-40  border-b-8 border-secondary">
                    Data Insights - CraftLore Platform Milestones : Year {dayjs().year()}
                </p>
                <div className="col-span-2 grid grid-cols-2 my-20">
                    <p className="col-span-1 text-2xl font-opensans">
