...
export const RegistrationProcess = () => {
  return (
    <div>
      <div className="h-80 bg-[#e5edf7]" />
      <div className="mx-6 lg:container">
        <div className="lg:container">
          <div className="relative -mt-[192px] space-y-6 rounded-t-xl border-b-8 border-secondary bg-primary py-12 text-center font-opensans font-bold text-white lg:container">
