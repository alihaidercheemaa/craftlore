    ...
    <section className="col-span-12 gap-4 bg-[#e5edf7]">
      <Container className="my-32 grid gap-12">
        ...
        <p className="font-opensans text-xl leading-[31px]">
          ...
          empowers women artisans, businesses, and policymakers to make informed
          decisions that enhance gender inclusivity and economic opportunities
          in the sector.
        </p>
        ...
        <p className="font-opensans text-xl leading-[31px]">
          The mission of the Kashmir Handicraft Gender Economic Study Center is
          to promote gender equality and economic empowerment in the handicraft
